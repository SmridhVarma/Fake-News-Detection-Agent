...
print("\n=== LOAD TRAINING ARTIFACTS (V1) ===")
artifacts = load_artifacts(TRAINING_ARTIFACT_PATH)

if artifacts is None:
    raise ValueError("No v1 training artifacts found.")
...
summary_lines = []
summary_lines.append("=== SENSE CHECK V1 ===")
...
overlap_csv_path = os.path.join(OUTPUT_DIR, "v1_high_similarity_matches.csv")
...
top_words_csv_path = os.path.join(OUTPUT_DIR, "v1_top_predictive_words.csv")
...
ablation_csv_path = os.path.join(OUTPUT_DIR, "v1_first_sentence_ablation.csv")
...
# SAVE SUMMARY TXT
# =========================================================
summary_txt_path = os.path.join(OUTPUT_DIR, "v1_sense_check_summary.txt")
